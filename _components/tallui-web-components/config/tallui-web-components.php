...
return [
    ...
    | By default all components from tallui-web-components are loaded in. You can
    ...
    */
    ...
    | for your app. By default all components from tallui-web-components are loaded in.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all tallui-web-components components.
