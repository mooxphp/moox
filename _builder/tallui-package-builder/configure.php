...
{
    return (array) preg_split('/\\r\\n|\\r|\\n/', run((string) 'dir /S /B * | findstr /v /i .git\ | findstr /v /i vendor | findstr /v /i ' . basename((string) __FILE__) . ' | findstr /r /i /M /F:/ ":author :vendor :package Usetall tallui-package-builder tallui_package_builder tallui_package_builder_migration vendor_name vendor_slug builder@tallui.io"'));
}

/** @return array<string> */
function replaceForAllOtherOSes(): array
{
    return explode(PHP_EOL, run('grep -E -r -l -i ":author|:vendor|:package|Usetall|tallui-package-builder|tallui_package_builder|tallui_package_builder_migration|vendor_name|vendor_slug|builder@tallui.io" --exclude-dir=vendor ./* ./.github/* | grep -v ' . basename(__FILE__)));
}
...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('resources/views/components/blade/tallui-package-builder-blade-component.blade.php')) => rename($file, determineSeparator('./resources/views/components/blade/' . $packageSlug . '-blade-component.php')),
        str_contains($file, determineSeparator('resources/views/components/livewire/tallui-package-builder-livewire-component.blade.php')) => rename($file, determineSeparator('./resources/views/components/livewire/' . $packageSlug . '-livewire-component.php')),
        str_contains($file, determineSeparator('src/Components/Blade/TalluiPackageBuilderBladeComponent.php')) => rename($file, determineSeparator('./src/Components/Blade/' . $className . 'BladeComponent.php')),
        str_contains($file, determineSeparator('src/Components/Livewire/TalluiPackageBuilderLivewireComponent.php')) => rename($file, determineSeparator('./src/Components/Livewire/' . $className . 'LivewireComponent.php')),
        ...
        str_contains($file, determineSeparator('database/migrations/create_tallui-package-builder_table.php.stub')) => rename($file, determineSeparator('./database/migrations/create_' . title_snake($packageSlugWithoutPrefix) . '_table.php.stub')),
        str_contains($file, determineSeparator('config/tallui-package-builder.php')) => rename($file, determineSeparator('./config/' . $packageSlugWithoutPrefix . '.php')),
