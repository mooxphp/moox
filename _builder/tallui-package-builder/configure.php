...
{
    return (array) preg_split('/\\r\\n|\\r|\\n/', run((string) 'dir /S /B * | findstr /v /i .git\ | findstr /v /i vendor | findstr /v /i '.basename((string) __FILE__).' | findstr /r /i /M /F:/ ":author :vendor :package Usetall skeleton tallui_package_builder tallui_package_builder_migration vendor_name vendor_slug builder@tallui.io"'));
}

/** @return array<string> */
function replaceForAllOtherOSes(): array
{
    return explode(PHP_EOL, run('grep -E -r -l -i ":author|:vendor|:package|Usetall|skeleton|tallui_package_builder|tallui_package_builder_migration|vendor_name|vendor_slug|builder@tallui.io" --exclude-dir=vendor ./* ./.github/* | grep -v '.basename(__FILE__)));
}
