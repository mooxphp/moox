...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=exo:400,600,800" rel="stylesheet" />

    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-[#001829] bg-no-repeat bg-right-top text-[#0e9bdc]"
    style="
    ...
    <header>
        <nav class="flex justify-between m-8">
            ...
            <div class="flex items-center text-3xl">
                ...
                >Custom</a>
                -->
                <a class="px-4 text-lg hover:text-[#69bce2]" href="/demo">Demo</a>
