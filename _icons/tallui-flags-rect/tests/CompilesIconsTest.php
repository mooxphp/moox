...
use Usetall\TalluiFlagsRect\TalluiFlagsRectServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('flagr-tallui')->toHtml();
    ...
    {
        $result = svg('flagr-tallui', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('flagr-tallui', ['style' => 'color: #555'])->toHtml();
    ...
    {
        return [
            TalluiFlagsRectServiceProvider::class,
        ];
    }
}
