...
use Usetall\TalluiFlagsCircle\TalluiFlagsCircleServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('flagc-tallui')->toHtml();
    ...
    {
        $result = svg('flagc-tallui', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('flagc-tallui', ['style' => 'color: #555'])->toHtml();
    ...
    {
        return [
            TalluiFlagsCircleServiceProvider::class,
        ];
    }
}
