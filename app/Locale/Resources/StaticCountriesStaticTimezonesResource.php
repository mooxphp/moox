...
use App\Locale\Resources\StaticCountriesStaticTimezonesResource\Pages;
...
class StaticCountriesStaticTimezonesResource extends Resource
{
    ...
    protected static ?string $model = \App\Locale\Models\StaticCountriesStaticTimezones::class;
                            ...
                            Section::make()
                                ->schema([
                                    Select::make('country_id')
                                        ->label(__('entities/static-countries-static-timezones.country'))
                                        ->relationship('country', 'alpha3_t')
                                        ->searchable()
                                        ->preload()->required(),
                                    Select::make('timezone_id')
                                        ->label(__('entities/static-countries-static-timezones.timezone'))
        ...
        return $table
            ->columns([
                TextColumn::make('country.alpha3_t')
                    ->label(__('entities/static-countries-static-timezones.country_alpha3_t'))
                    ->sortable(),
                TextColumn::make('timezone.name')
                    ->label(__('entities/static-countries-static-timezones.timezone_name'))
                    ->sortable(),
            ])
            ->defaultSort('id', 'desc')
