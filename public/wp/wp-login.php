...
function login_header($title = null, $message = '', $wp_error = null)
{
    ...
    ?>
	<?php
    if ($action !== 'confirm_admin_email' && ! empty($title)) {
        ?>
...
switch ($action) {
    ...
    default:
        ...
        if (isset($_POST['log'])) {
            $user_login = ($errors->get_error_code() === 'incorrect_password' || $errors->get_error_code() === 'empty_password') ? wp_unslash($_POST['log']) : '';
        }
