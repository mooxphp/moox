...
function wp_interactivity_process_directives_of_interactive_blocks(array $parsed_block): array
{
     ...
     */
    if ($root_interactive_block === null) {
        ...
        if (
            ...
            (isset($block_type->supports['interactivity']['interactive']) && $block_type->supports['interactivity']['interactive'] === true))
        ) {
            // Annotates the root interactive block for processing.
            $root_interactive_block = [$block_name, $parsed_block];
            ...
            $process_interactive_blocks = static function (string $content, array $parsed_block) use (&$root_interactive_block, &$process_interactive_blocks): string {
                ...
                [$root_block_name, $root_parsed_block] = $root_interactive_block;
