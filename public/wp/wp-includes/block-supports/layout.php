...
function wp_restore_group_inner_container($block_content, $block)
{
    ...
    if (
        ...
        (isset($block['attrs']['layout']['type']) && ($block['attrs']['layout']['type'] === 'flex' || $block['attrs']['layout']['type'] === 'grid'))
    ) {
        return $block_content;
    }
