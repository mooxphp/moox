...
class WP_Navigation_Block_Renderer
{
    ...
    private static function is_responsive($attributes)
    {
        ...
        return isset($attributes['overlayMenu']) && $attributes['overlayMenu'] !== 'never' || $has_old_responsive_attribute;
    }
    ...
    {
        if (static::$has_submenus === true) {
            return static::$has_submenus;
        }

        foreach ($inner_blocks as $inner_block) {
            // If this is a page list then work out if any of the pages have children.
            if ($inner_block->name === 'core/page-list') {
                $all_pages = get_pages(
                    [
            ...
            if ($inner_block->name === 'core/navigation-submenu') {
                static::$has_submenus = true;
                break;
            }
        }
