...
class WP_REST_Templates_Controller extends WP_REST_Controller
{
    ...
    {
        if (isset($request['source']) && ($request['source'] === 'theme' || $request['source'] === 'plugin')) {
    ...
    {
        if ($template_object->type === 'wp_template' || $template_object->type === 'wp_template_part') {
            /*
             * Added by theme.
            ...
            // Added by plugin.
            if ($template_object->origin === 'plugin') {
                return 'plugin';
            }
