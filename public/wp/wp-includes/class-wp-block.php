...
class WP_Block
{
            ...
            case 'rich-text':
                ...
                foreach ($selectors as $selector) {
                    ...
                    if (strcasecmp($block_reader->get_tag($selector), $selector) === 0 || $block_reader->next_tag(
                        ...
                        if ($this->name === 'core/paragraph' || $this->name === 'core/heading') {
    ...
    public function render($options = [])
    {
        ...
        if (
            $interactivity_process_directives_enabled && $root_interactive_block === null && (
                (isset($this->block_type->supports['interactivity']) && $this->block_type->supports['interactivity'] === true) ||
