...
class WP_Image_Editor_GD extends WP_Image_Editor
{
    ...
    public function load()
    {
        ...
        if (
            function_exists('imagecreatefromwebp') && (wp_get_image_mime($this->file) === 'image/webp')
        ) {
            $this->image = @imagecreatefromwebp($this->file);
        } elseif (
            function_exists('imagecreatefromavif') && (wp_get_image_mime($this->file) === 'image/avif')
        ) {
    ...
    public function set_quality($quality = null)
    {
        ...
        try {
            if ($this->mime_type === 'image/webp' && defined('IMG_WEBP_LOSSLESS')) {
                $webp_info = wp_get_webp_info($this->file);
                if (! empty($webp_info['type']) && $webp_info['type'] === 'lossless') {
