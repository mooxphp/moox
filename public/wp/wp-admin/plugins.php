...
if (current_user_can('install_plugins')) {
    get_current_screen()->add_help_tab(
        [
            ...
            'content' => '<p>'.__('Plugin Dependencies aims to make the process of installing and activating add-ons (dependents) and the plugins they rely on (dependencies) consistent and easy.').'</p>'.
