...
return [
    ...
    'layout_help' => 'Layout, header, default body and footer come from this layout.',
    'logo' => 'Logo',
    'logo_help' => 'Leave empty to use the logo from the layout.',
    'mail_content' => 'Mail content (MJML)',
    'mail_content_help' => 'Leave empty to use the default body from the layout. A value here replaces only the body, not header or footer.',
    'footer' => 'Footer (MJML)',
    'footer_help' => 'Leave empty to use the default footer from the layout.',
    'preview' => 'Preview',
    'subject' => 'Subject',
    'send' => 'Send',
    'send_submit' => 'Send',
