        ...
        <div x-show="showEditThemeModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full" @click.stop
                ...
                <div class="flex justify-between items-center p-6 border-b border-gray-200">
                    ...
                    <button type="button" @click="closeEditThemeModal()" class="p-2 hover:bg-gray-100 rounded-lg transition-colors"
                        title="Schließen">
                ...
                <div class="flex justify-end gap-3 p-6 border-t border-gray-200">
                    <button type="button" @click="closeEditThemeModal()"
                        class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                        Abbrechen
                    </button>
                    <button type="button" @click="updateTheme()" :disabled="!editThemeName || !editThemeName.trim()"
