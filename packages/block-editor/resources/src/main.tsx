...
const mode = validModes.includes(urlMode as any) ? urlMode as "web" | "mail" : null;
      ...
      <div class="flex justify-center items-center min-h-screen text-white bg-zinc-900">
        <div class="space-y-6 text-center">
          ...
          <div class="flex gap-4 justify-center">
            ...
            <a href="?mode=mail" class="px-6 py-3 font-medium bg-blue-500 rounded-md transition-colors hover:bg-blue-600">
              Mail Editor
            </a>
          </div>
        </div>
