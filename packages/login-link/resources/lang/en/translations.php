...
return [
    ...
    'mail_intro' => 'Click the button below to continue.',
    'mail_cta' => 'Sign in',
    ...
    'content_help' => 'Optional copy for the HTML mail. Used only when moox/mail-template is not installed.',
    'handler_key' => 'Handler',
    'handler_key_unregistered' => 'The selected handler is not registered.',
    'template_key' => 'Mail template',
    'template_key_help' => 'Mail body and branding come from the selected template slug. The email subject is the process title above. New templates get a minimal body with {magicLink}.',
    'template_key_required' => 'A mail template is required.',
    'template_slug' => 'Slug',
