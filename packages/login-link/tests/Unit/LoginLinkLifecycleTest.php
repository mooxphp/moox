...
it('invalidates prior valid links for the same process and subject', function (): void {
    ...
    $first = $service->issue('verify-address', $subject, 'ap@example.com', 'admin', $request);
    $second = $service->issue('verify-address', $subject, 'ap@example.com', 'admin', $request);
