...
namespace Moox\MooxPressWiki\Commands;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'mooxmoox-press-wiki:install';
     ...
     * @var string
     */
    protected $description = 'Installs Moox MooxPressWiki, publishes configuration, migrations and registers plugins.';
    ...
    {
        info('Welcome to Moox MooxPressWiki Installer');
    }
    ...
    public function publishMigrations(): void
    {
        if (confirm('Do you wish to publish the migrations?', true)) {
            if (Schema::hasTable('moox_press_wikis')) {
                warning('The moox_press_wikis table already exists. The migrations will not be published.');

                return;
            }
            info('Publishing WpWikis Migrations...');
            $this->callSilent('vendor:publish', ['--tag' => 'moox-press-wiki-migrations']);
        }
    }
    ...
    public function runMigrations(): void
    {
        if (confirm('Do you wish to run the migrations?', true)) {
            info('Running MooxPressWiki Migrations...');
    ...
    public function registerPlugins(string $providerPath): void
    {
        if (File::exists($providerPath)) {
            ...
            $pluginsToAdd = multiselect(
                ...
                options: ['MooxPressWikiPlugin', 'MooxPressThemaPlugin'],
                default: ['MooxPressWikiPlugin', 'MooxPressThemaPlugin'],
            );
    ...
    {
        note('Moox MooxPressWiki installed successfully. Enjoy!');
    }
}
