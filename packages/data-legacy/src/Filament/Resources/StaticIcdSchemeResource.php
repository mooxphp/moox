...
use Moox\DataLegacy\Filament\Resources\StaticIcdSchemeResource\Pages\CreateStaticIcdScheme;
use Moox\DataLegacy\Filament\Resources\StaticIcdSchemeResource\Pages\EditStaticIcdScheme;
use Moox\DataLegacy\Filament\Resources\StaticIcdSchemeResource\Pages\ListStaticIcdSchemes;
use Moox\DataLegacy\Filament\Resources\StaticIcdSchemeResource\Pages\ViewStaticIcdScheme;
use Moox\DataLegacy\Models\StaticIcdScheme;

class StaticIcdSchemeResource extends BaseRecordResource
{
    protected static ?string $model = StaticIcdScheme::class;

    protected static string|\BackedEnum|null $navigationIcon = 'gmdi-fingerprint';
