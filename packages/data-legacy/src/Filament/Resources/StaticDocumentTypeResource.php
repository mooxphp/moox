...
use Moox\DataLegacy\Filament\Resources\StaticDocumentTypeResource\Pages\CreateStaticDocumentType;
use Moox\DataLegacy\Filament\Resources\StaticDocumentTypeResource\Pages\EditStaticDocumentType;
use Moox\DataLegacy\Filament\Resources\StaticDocumentTypeResource\Pages\ListStaticDocumentTypes;
use Moox\DataLegacy\Filament\Resources\StaticDocumentTypeResource\Pages\ViewStaticDocumentType;
use Moox\DataLegacy\Models\StaticDocumentType;

class StaticDocumentTypeResource extends BaseRecordResource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Filter::make('en16931_interpretation')
                    ->schema([
                        TextInput::make('en16931_interpretation')
                            ->label(__('data::fields.en16931_interpretation'))
                            ->placeholder(__('core::core.search')),
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        return $query->when(
                            $data['en16931_interpretation'],
                            fn (Builder $query, $value): Builder => $query->where('en16931_interpretation', 'like', "%{$value}%"),
                        );
                    })
                    ->indicateUsing(function (array $data): ?string {
                        if (! $data['en16931_interpretation']) {
                            return null;
                        }

                        return 'EN 16931: '.$data['en16931_interpretation'];
                    }),
            ]);
    }
