...
/**
 * Verifies a downloaded veraPDF installer against a pinned SHA-256 digest.
 */
    ...
    public static function assertMatches(string $filePath, string $expectedSha256): void
    {
        ...
        if ($expected === '' || preg_match('/^[a-f0-9]{64}$/', $expected) !== 1) {
            throw new RuntimeException(
                'Installer checksum is not configured. Set verapdf.installer.sha256 (or VERAPDF_INSTALLER_SHA256) to the SHA-256 of the pinned installer zip.'
            );
        }
