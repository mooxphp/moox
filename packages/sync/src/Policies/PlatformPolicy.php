...
class PlatformPolicy
{
     ...
     */
    public function view(Authorizable $user, Platform $platform): bool
    {
     ...
     */
    public function update(Authorizable $user, Platform $platform): bool
    {
     ...
     */
    public function delete(Authorizable $user, Platform $platform): bool
    {
     ...
     */
    public function forceDelete(Authorizable $user, Platform $platform): bool
    {
     ...
     */
    public function restore(Authorizable $user, Platform $platform): bool
    {
     ...
     */
    public function replicate(Authorizable $user, Platform $platform): bool
    {
