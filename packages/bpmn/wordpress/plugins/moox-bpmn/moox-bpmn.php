...
class Moox_BPMN_Plugin
{
    ...
    {
        $mode = isset($_GET['moox_bpmn_mode'])
            ? sanitize_text_field($_GET['moox_bpmn_mode'])
            : 'view';
        ...
        if ($mode === 'edit') {
            wp_enqueue_script(
                'bpmn-js',
                MOOX_BPMN_PLUGIN_URL.'node_modules/bpmn-js/dist/bpmn-modeler.production.min.js',
                [],
                '18.8.0',
                true
            );
            ...
            wp_enqueue_script(
                'bpmn-js',
                MOOX_BPMN_PLUGIN_URL.'node_modules/bpmn-js/dist/bpmn-navigated-viewer.production.min.js',
                [],
                '18.8.0',
                true
            );
