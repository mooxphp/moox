...
return [
    ...
    // Job refers to Laravel's job queue, should not be translated
    'job_waiting' => 'Auftrag wartet',
    // Jobs refers to Laravel's job queue, should not be translated
    'jobs_waiting' => 'Aufträge warten',
    // Job refers to Laravel's job queue, should not be translated
    'job_failed' => 'Auftrag fehlgeschlagen',
    // Jobs refers to Laravel's job queue, should not be translated
    'jobs_failed' => 'Aufträge fehlgeschlagen',
    ...
    // Jobs refers to Laravel's job queue, should not be translated
    'delete_all_failed_jobs' => 'Alle fehlgeschlagenen Aufträge löschen',
    // Jobs refers to Laravel's job queue, should not be translated
    'delete_all_failed_jobs_notification' => 'Alle fehlgeschlagenen Aufträge wurden entfernt.',
    // Jobs refers to Laravel's job queue, should not be translated
