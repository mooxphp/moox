...
return [
    ...
    'lock_reason' => 'பூட்டு காரணம்',
    // Model Compatibility Warning
    'model_compatibility_warning' => 'மாதிரி பொருந்தக்கூடிய எச்சரிக்கை',
    // The selected models are not fully compatible
    'models_are_not_fully_compatible' => 'தேர்ந்தெடுக்கப்பட்ட மாதிரிகள் முழுமையாக பொருந்தாது',
    // Missing columns
    'missing_columns' => 'நெடுவரிசைகளைக் காணவில்லை',
    // Extra columns
    'extra_columns' => 'கூடுதல் நெடுவரிசைகள்',
    // Please map fields manually
    'please_map_fields_manually' => 'தயவுசெய்து புலங்களை கைமுறையாக வரைபடமாக்கவும்',
];
