...
namespace Moox\Core\Entities\Items\Static\Filament\Concerns;
    ...
    protected static function staticCodelistFormFields(): array
    {
        return [
            TextInput::make('common_name')
                ->label(__('core::static.common_name'))
                ->required()
                ->maxLength(255),
            Textarea::make('description')
                ->label(__('core::static.description'))
                ->columnSpanFull(),
        ];
    }
    ...
    protected static function staticCodelistCommonNameFilter(): Filter
    {
        return Filter::make('common_name')
            ...
            ->indicateUsing(function (array $data): ?string {
                ...
                return __('core::static.common_name').': '.$data['common_name'];
            });
    }
