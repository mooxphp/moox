...
class StaticTimezoneResource extends Resource
{
    ...
    protected static ?string $model = \Moox\DataLanguages\Models\StaticTimezone::class;

    protected static ?string $navigationIcon = 'gmdi-travel-explore-o';

    public static function getModelLabel(): string
    {
        return __('data-languages::static-timezone.static_timezone');
    }

    public static function getPluralModelLabel(): string
    {
        return __('data-languages::static-timezone.static_timezones');
    }
