...
class StaticCountriesStaticCurrenciesResource extends Resource
{
    ...
    protected static ?string $model = \Moox\DataLanguages\Models\StaticCountriesStaticCurrencies::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    public static function getModelLabel(): string
    {
        return __('data-languages::static-countries-static-currencies.static_countries_static_currencies');
    }
