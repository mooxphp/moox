...
namespace Moox\DataLanguages\Commands;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'data-languages:install';
     ...
     * @var string
     */
    protected $description = 'Installs Moox DataLanguages, publishes configuration, migrations and registers plugins.';
    ...
    {
        info('Welcome to Moox DataLanguages Installer');
    }

    public function publishConfiguration(): void
    {
        if (confirm('Do you wish to publish the configuration?', true)) {
            if (! File::exists('config/data-languages.php')) {
                info('Publishing DataLanguages Configuration...');
                $this->callSilent('vendor:publish', ['--tag' => 'data-languages-config']);

                return;
            }
            warning('The DataLanguages config already exist. The config will not be published.');
        }
    }
    ...
    public function publishMigrations(): void
    {
        if (confirm('Do you wish to publish the migrations?', true)) {
            ...
            info('Publishing DataLanguages Migrations...');
            $this->callSilent('vendor:publish', ['--tag' => 'data-languages-migrations']);
        }
    }
    ...
    public function runMigrations(): void
    {
        if (confirm('Do you wish to run the migrations?', true)) {
            info('Running DataLanguages Migrations...');
    ...
    {
        note('Moox DataLanguages installed successfully. Enjoy!');
    }
}
