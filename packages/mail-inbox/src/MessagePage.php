 ...
 *   Null when this fetch round is finished. Still set when a per-run page
 *   limit stops mid-catch-up so the next run can resume there.
 * - {@see $resumeCursor} — where the next scheduled poll should start. Set
 *   only on the last page of a round, when {@see $continuationCursor} is null.
 *
