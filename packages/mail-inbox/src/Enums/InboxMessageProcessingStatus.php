 ...
 * - processed: All attachments terminal and successful path; driver settlement complete when applicable.
 * - failed: Terminal error; driver may have settled the message as failed when applicable.
