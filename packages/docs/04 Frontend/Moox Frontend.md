...
class ProductFrontend
{
    ...
    {
        return [
            'single' => $this->defaultSingleLayout(),
            'teaser' => $this->defaultTeaserLayout(),
          	'list' => $this->defaultListLayout(), // simple, nested, child
        ];
    }
                                    ...
                                    "children" => [
                                        [
                                            ...
                                            "props" => [
                                                ...
                                                "placeholder" => ["/demo/demo1.jpg", "/demo/demo2.jpg"],
                                    ...
                                    "children" => [
                                        ...
                                        [
                                            ...
                                            "props" => [
                                                ...
                                                "placeholder" => "This is a short product description for demo purposes.",
                                                "usePlaceholderWhenEmpty" => true
                                            ]
                                        ],
                                        [
                            ...
                            "props" => [
                                ...
                                "placeholder" => [
                                    [
                                        "type" => "Paragraph",
                                        "props" => [
                                            "text" => "Add more details about your product here."
                                        ]
                                    ]
                                ],
                                "usePlaceholderWhenEmpty" => true
    ...
    public function defaultTeaserLayout(): array
    {
        return [
                    ...
                    "children" => [
                        [
                            ...
                            "props" => [
                                ...
                                "placeholder" => "/demo/demo-thumb.jpg",
                                "usePlaceholderWhenEmpty" => true
                            ]
                        ],
                        [
      ...
      "children": [
        {
          ...
          "props": {
            "content": [],
            "placeholder": [
              { "type": "Paragraph", "props": { "text": "Add more details about your product here." } }
            ],
            "usePlaceholderWhenEmpty": true
          }
        }
