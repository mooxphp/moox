---
title: Data
description: Moox Data plugins deliver static data for apps and eCommerce.
---

# Data

Moox Data itself provides static data for countries, currencies, languages and timezones.

For example Moox Data Germany extends that to prefill address fields from own data instead of using an API.
