                ...
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Highly Customizable</p>
                        </dt>
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Well Documented</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
                    ...
                    <div class="relative">
                        <dt>
                            ...
                            <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Modern Architecture</p>
                        </dt>
                        <dd class="mt-2 ml-16 text-base text-gray-500">
