                            ...
                            Section::make()
                                ->schema([
                                    ...
                                    KeyValue::make('options')
                                        ->label('Options')
                                        ->helperText('Optionale JSON-Optionen pro Endpoint. Queue: queue, queue.tries, queue.timeout, queue.max_exceptions, queue.backoff, queue.retry_until_minutes, queue.overlap.release_after, queue.overlap.expire_buffer, queue.overlap.expire_min, queue.deadlock_retry.attempts, queue.deadlock_retry.delays_ms (überschreibt Connection/Config). Weitere Keys: tree.stop_on_http_error => true, sync.purge_after_days => 30.'),
