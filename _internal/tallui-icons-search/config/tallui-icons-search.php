...
use Usetall\TalluiIconsSearch\Components;
...
return [
    ...
    | By default all components from tallui-icons-search are loaded in. You can
    ...
    */
    ...
    | for your app. By default all components from tallui-icons-search are loaded in.
    |
    */

    'livewire' => [
        'tallui-icons-search' => Components\Livewire\TalluiIconsSearch::class,
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all tallui-icons-search components.
