...
final class PublishCommand extends Command
{
    ...
    {
        $components = config('tallui-core.components');
        ...
        $class = str_replace('TallUiCore\\Components\\', '', $component);
        ...
        if ($this->option('view') || ! $this->option('class')) {
            ...
            $publishedView = $this->laravel->resourcePath('views/vendor/tallui-core/components/'.$view);
        ...
        if ($this->option('class') || ! $this->option('view')) {
            ...
            if ($filesystem->missing($config = $this->laravel->configPath('tallui-core.php'))) {
                $this->call('vendor:publish', ['--tag' => 'tallui-core-config']);
            }
