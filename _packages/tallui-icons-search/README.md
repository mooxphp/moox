...
This is a simple icons search package.
...
```bash
composer require usetall/tallui-icons-search
```

You can publish and run the migrations with:

```bash
php artisan vendor:publish --tag="tallui-icons-search-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="tallui-icons-search-config"
```

Optionally, you can publish the views using

```bash
php artisan vendor:publish --tag="tallui-icons-search-views"
```
