...
class JobsPlugin implements Plugin
{
    ...
    {
        return $this->resource ?? config('jobs.resources.jobs.resource');
    }
    ...
    {
        return $this->evaluate($this->label) ?? config('jobs.resources.jobs.label');
    }
    ...
    {
        return $this->evaluate($this->pluralLabel) ?? config('jobs.resources.jobs.plural_label');
    }
    ...
    {
        return $this->navigationGroup ?? config('jobs.resources.jobs.navigation_group');
    }
    ...
    {
        return $this->navigationIcon ?? config('jobs.resources.jobs.navigation_icon');
    }
    ...
    {
        return $this->navigationSort ?? config('jobs.resources.jobs.navigation_sort');
    }
    ...
    {
        return $this->navigationCountBadge ?? config('jobs.resources.jobs.navigation_count_badge');
    }
    ...
    {
        return $this->navigation ?? config('jobs.resources.jobs.enabled');
    }
