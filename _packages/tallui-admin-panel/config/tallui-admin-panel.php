...
use Usetall\TalluiAdminPanel\Components;
...
return [
    ...
    | By default all components from tallui-admin-panel are loaded in. You can
    ...
    */
    ...
    | for your app. By default all components from tallui-admin-panel are loaded in.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value will set a prefix for all tallui-admin-panel components.
