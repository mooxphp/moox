...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/jbagsik"><img src="https://avatars.githubusercontent.com/u/234342240?v=4?s=100" width="100px;" alt="jbagsik"/><br /><sub><b>jbagsik</b></sub></a><br /><a href="https://github.com/mooxphp/moox/commits?author=jbagsik" title="Code">💻</a> <a href="#infra-jbagsik" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a></td>
    </tr>
  </tbody>
</table>
...
-   Do `php artisan moox:deploy` and `npm run build` before committing
...
-   Use https://github.com/mooxphp/build to create your own packages
...
Your commit messages will be merged into Changelog.md, means they become part of the documentation. Please make sure, you write something useful. We discuss to use [Conventional Commits](https://www.conventionalcommits.org/) in the future.

## Pull requests

Create a PR to `main` if your changes are ready for prime time.
...
We use the `php artisan moox:release` command to craft new releases. It is part of the Moox Monorepo package. Of course that command is only working for Moox Release Managers (currently Alf, Kim and Aziz).
...
-   [Codacy](https://app.codacy.com/gh/mooxphp/moox/)
